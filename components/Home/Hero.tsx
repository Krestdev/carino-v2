...
const Hero = () => {
  ...
  const message = 'Pour 2 pizzas🍕🍕 achetées, 1 pizza🍕 offerte ! Profitez-en du 10 juillet au 05 Septembre 2025 exclusivement sur notre site.'
  return (
    <div style={{
      ...
      <div className='px-0 lg:px-24 z-10'>
        <div className='flex flex-col gap-4 px-8 w-fit'>
          ...
          <div className='flex flex-col gap-8'>
            <p className='text-white text-[14px] w-[320px] md:text-[24px] md:w-[700px] leading-[150%]'>{config.description}</p>
      ...
      <div className='absolute bottom-0 left-0'>
        <PromoMessage start={new Date()} end={new Date(2025, 8, 5)} message={message} />
      </div>
    </div>
  )
}

...
import { ProductOption, OptionValue, ProdData } from "@/types/types";
...
function AddDialog({ children, options, product }: DialogProps) {
  ...
  const onSubmit = useCallback((data: FormValues) => {
    ...
    setOpen(false);
  }, [addToCart, product, calculateTotal, router, validateOptions]);

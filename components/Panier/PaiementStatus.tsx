...
interface PaiementStatusProps {
    ...
    retryPayment: UseMutationResult<checkTransactionStatus, Error, Retry, unknown>
}
        ...
        <Dialog open={!!status} onOpenChange={isPending ? undefined : onClose}>
            ...
            >
                ...
                <div className="px-6 pb-6 pt-4 flex flex-col items-center text-center gap-5">
                    ...
                    {/* Icon */}
                    <div className={cn("w-16 h-16 rounded-2xl flex items-center justify-center", config.bgClass)}>

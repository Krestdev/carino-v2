            ...
            <View style={styles.header}>
                ...
                <View style={styles.body}>
                    <View style={styles.headsection}>
                        ...
                        <Text style={styles.headDescription}>{"Service de restauration – plats et boissons consommés sur place / à emporter / Livraison."}</Text>
                    </View>
                    <View style={styles.section}>
                        ...
                        <View style={styles.subSection}>
                            <Text style={styles.subSectionLabel}>{"Adresse de livraison:"}</Text>
                            <Text style={styles.subSectionValue}>{order.deliveryAddress}</Text>
                        </View>
                        <View style={{
                            display: "flex",
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.subSection}>
                            <Text style={styles.subSectionLabel}>{"Frais de livraison:"}</Text>

...
const ProfilComp = ({ orders }: { orders: PreviousOrders }) => {
            ...
            <div className='w-full h-auto flex flex-col bg-[#E4E4E7]'>
                ...
                <div className='flex flex-col gap-2 p-5'>
                    ...
                    <div>
                        ...
                        <p className='text-[12px]'>{lastOrder.created_at.toString().slice(0, 10)}</p>
                    </div>
                </div>
            </div>
            <div className='w-full h-auto flex flex-col bg-[#E4E4E7]'>
                    ...
                    <div>
                        ...
                        <div className='flex flex-row items-end justify-between max-w-[291px]'>
                            <div>
                                ...
                                <Input placeholder='****' className='border-black w-[124px] rounded-[12px]' />
                            </div>
                            <Button variant={"outline"} className='border-black text-black rounded-[12px]'>
                                <LuSquarePen />
                                {"Modifier"}
                            </Button>
                        </div>

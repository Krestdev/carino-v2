...
const requestInterceptorSetup = (api: AxiosInstance) => {
...
const responseInterceptorSetup = (api: AxiosInstance) => {
...
requestInterceptorSetup(api1);
responseInterceptorSetup(api1);
...
requestInterceptorSetup(api2);
responseInterceptorSetup(api2);